...
<body>
    <div class="main">
        ...
        <div class="main-box row">
            <div class="box-left col-2">
                <div class="image">
                    <div class="image-admin ">
                        <img src="../img/ghế bập bênh.jpeg" alt="">
                    </div>
                    <h6 class="name">Trương Huấn</h6>
                    <p>Chào mừng đã trở lại</p>
                    <div class="line"></div>
                </div>

                <div class="list-categories">
                    <ul>
                        <li><a href="index.php?act=listdanhmuc"><i class="fa fa-home" aria-hidden="true"></i> Quản lí
                                danh mục
                                phòng</a></li>
                        <li><a href="index.php?act=khachsan"><i class="fa-solid fa-hotel"></i> Quản lí khách
                                sạn</a>
                        </li>
